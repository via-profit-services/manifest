...
> Материал для самостоятельного изучения на дожность Fullstack разработчик
...
Для включения в разработку и возможнсти выполнения поставленных задач потребуется знание и умение использовать инструменты и технологии, представленные ниже.

### TypeScript

![Alt text](assets/typescript.png)

Весь код пишется на TypeScript. JavaScript в числом виде почти не используется. Строгая типизация обязательна.
...
- [Relay Runtime](https://relay.dev/docs/api-reference/store/ "‌") - Основа Relay, которая представлет собой Store, в котором Relay хранит своё состояние.
